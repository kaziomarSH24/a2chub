					...
					<div class="col-lg col-md-6 col-sm-6 dashboard-border-right mt-auto mb-auto">
						...
						<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber|admin')): ?>
							<?php if(config('settings.image_feature_user') == 'allow'): ?>
								<div class="col-lg col-md-6 col-sm-6 dashboard-border-right mt-auto mb-auto" style="display:none">
					...
					<div class="row">
						...
						<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber|admin')): ?>
                    		<?php if(config('settings.voiceover_feature_user') == 'allow'): ?>
								<div class="col-lg col-md-4 col-sm-12" style="display:none">
									<div class="card overflow-hidden user-dashboard-special-box">
										<div class="card-body d-flex">
											<div class="usage-info w-100">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a2chub project full source code backup\public_html\resources\views/user/dashboard/index.blade.php ENDPATH**/ ?>
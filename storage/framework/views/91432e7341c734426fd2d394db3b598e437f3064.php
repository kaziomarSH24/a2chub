<?php $__env->startSection('css'); ?>
    ...
    <style>
        .gradient-text {
    background: linear-gradient(151deg, #41c0f9 0%, #26bcff 0.01%, #99defe 96.78%);
...
<?php $__env->startSection('content'); ?>
  ...
  <h1 data-aos="fade-up" data-aos-delay="100" data-aos-once="true" data-aos-duration="200"><?php echo e(__('Ultimate AI Creator')); ?></h1>
<div class="word-container" data-aos="fade-up" data-aos-delay="150" data-aos-once="true" data-aos-duration="300">
    <h1 class="ah-headline">
        <span class="ah-words-wrapper text-center">
            <b class="is-visible gradient-text"><?php echo e(__('Article Generator')); ?></b>
            <b class="gradient-text"><?php echo e(__('Content Improver')); ?></b>
            <b class="gradient-text"><?php echo e(__('Blog Contents')); ?></b>
            <b class="gradient-text"><?php echo e(__('Ad Creations')); ?></b>
            <b class="gradient-text"><?php echo e(__('And Many More!')); ?></b>
        </span>
    </h1>
</div>
                                ...
                                <p class="fs-16" data-aos="fade-up" data-aos-delay="400" data-aos-once="true" data-aos-duration="700"><?php echo e(__('One platform to generate all AI contents')); ?></p>
                                ...
                                <div>
                                    <span class="fs-12" data-aos="fade-up" data-aos-delay="900" data-aos-once="true" data-aos-duration="1300" style="font-weight:600"><?php echo e(__('Grab your 4000 credits for free')); ?></span>
                                </div>
        ...
        <!-- SECTION - BANNER
        ========================================================-->
        <section id="info-banner" style="display:none">
            <div class="container">
        ...
        <!-- SECTION - TEMPLATES
        ========================================================-->
        <section id="templates-wrapper" style="display:none">
        ...
        <!-- SECTION - IMAGES
        ========================================================-->
        <section id="images-wrapper" style="display:none">
        ...
        <?php endif; ?>
         ...
         <!-- SECTION - BANNER
        ========================================================-->
        <section id="banner-wrapper" style="display:none">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a2chub project full source code backup\public_html\resources\views/home.blade.php ENDPATH**/ ?>
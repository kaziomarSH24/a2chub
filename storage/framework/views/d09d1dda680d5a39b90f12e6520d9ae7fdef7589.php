						...
						eventSource.onmessage = function (e) {
							...
							if ( e.data == '[DONE]' ) {	
								...
								if ( stream && stream !== '[DONE]') {		
								    ...
								    stream = stream.replace(/#+\s*(.*?)(<br>|$)/g, '<h3>$1</h3>');
                                    stream = stream.replace(/\*\*(.*?)\*\*/g, '<b>$1</b>');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\a2chub project full source code backup\public_html\resources\views/user/templates/original-template.blade.php ENDPATH**/ ?>
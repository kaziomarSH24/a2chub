...
<aside class="app-sidebar"> 
    ...
    <a class="side-menu__item" href="{{ route('user.dashboard') }}">
        <img src="{{ asset('img/frontend/features/layout.png') }}" alt="Dashboard Logo" class="side-menu__icon" style="width: 40px; height: 40px;">
        ...
        <img src="{{ asset('img/frontend/features/chat2.png') }}" alt="Dashboard Logo" class="side-menu__icon" style="width: 40px; height: 40px;">
                <span class="side-menu__label">{{ __('AI Assistant') }}</span></a>
            </li> 
        @endif
        
    
        <li class="slide active">
            <a class="side-menu__item" href="{{route('user.add.data')}}">
        ...
        <img src="{{ asset('img/frontend/features/folder.png') }}" alt="Dashboard Logo" class="side-menu__icon" style="width: 40px; height: 40px;">
        ...
        <div class="side-progress-position mt-4">
            <div class="side-plan-wrapper text-center pt-3 pb-3">
                ...
                <div class="view-credits mt-1" style="display:none"><a class=" fs-11 text-muted mb-2" href="javascript:void(0)" id="view-credits" data-bs-toggle="modal" data-bs-target="#creditsModel"><i class="fa-solid fa-coin-front text-yellow "></i> {{ __('View Credits') }}</a></div> 

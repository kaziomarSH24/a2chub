...
<div class="container mt-5">
    ...
    <form method="POST" action="{{ route('submit.add.data') }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('sat_english_score') is-invalid @enderror" id="sat_english_score" value="{{$application->sat_scores['english'] ?? '200'}}" name="sat_english_score" step="10" >
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('sat_math_score') is-invalid @enderror" id="sat_math_score" value="{{$application->sat_scores['math'] ?? '200'}}" name="sat_math_score" step="10">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="sat_total_score" name="sat_total_score" value="{{$application->sat_scores['total'] ?? '400'}}" >
        </div>

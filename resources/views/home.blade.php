...
@section('content')
  ...
  <h1 data-aos="fade-up" data-aos-delay="100" data-aos-once="true" data-aos-duration="200">{{ __('Ultimate AI Creator') }}</h1>
<div class="word-container" data-aos="fade-up" data-aos-delay="150" data-aos-once="true" data-aos-duration="300">
    <h1 class="ah-headline">
        <span class="ah-words-wrapper text-center">
            <b class="is-visible gradient-text">{{ __('Article Generator') }}</b>
            <b class="gradient-text">{{ __('Content Improver') }}</b>
            <b class="gradient-text">{{ __('Blog Contents') }}</b>
            <b class="gradient-text">{{ __('Ad Creations') }}</b>
            <b class="gradient-text">{{ __('And Many More!') }}</b>
        </span>
    </h1>
</div>
                                ...
                                <p class="fs-16" data-aos="fade-up" data-aos-delay="400" data-aos-once="true" data-aos-duration="700">{{ __('One platform to generate all AI contents') }}</p>
                                ...
                                <div>
                                    <span class="fs-12" data-aos="fade-up" data-aos-delay="900" data-aos-once="true" data-aos-duration="1300" style="font-weight:600">{{ __('Grab your 4000 credits for free') }}</span>
                                </div>

			...
			<div class="templates-nav-menu">
				<div class="template-nav-menu-inner">
					<ul class="nav nav-tabs" id="myTab" role="tablist" style="padding: 3px">
						...
						<li class="nav-item category-check" role="presentation">
							<button class="nav-link" id="trial-tab" data-bs-toggle="tab" data-bs-target="#trial" type="button" role="tab" aria-controls="trial" aria-selected="false">{{ __('Welcome Credit Features') }}</button>
						</li>				
					</ul>
				</div>
			</div>
					...
					<div class="tab-content" id="myTabContent">
						...
						<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
							<form id="general-features-form" action="{{ route('admin.davinci.configs.store') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="card shadow-0 mb-7" style="display:none">							
									<div class="card-body">
						...
						<div class="tab-pane fade" id="api" role="tabpanel" aria-labelledby="api-tab">
							<form id="api-features-form" action="{{ route('admin.davinci.configs.store.api') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="card shadow-0" style="display:none">							
									<div class="card-body">
						...
						<div class="tab-pane fade" id="extended" role="tabpanel" aria-labelledby="extended-tab" style="display:none">
									...
									<div class="card-body">
										...
										<div class="row">			
											...
											<div class="row">
												...
												<div class="col-lg-6 col-md-6 col-sm-12">							
													<div class="input-box">								
														<h6>{{ __('Image Results Storage Period') }} <span class="text-muted">({{ __('For Non-Subscribers') }})</span><i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="{{ __('After set days file results will be deleted via CRON task') }}."></i></h6>
														<div class="form-group">							    

...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['localeSessionRedirect', 'localizationRedirect', 'localeViewPath']], function () {
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['verified', '2fa.verify', 'role:user|admin|subscriber', 'subscription.check', 'PreventBackHistory']], function() {
        ...
        Route::controller(ChatbotController::class)->group(function () {
            Route::get('/additional/data', 'additionalDataForm')->name('user.add.data');
            Route::post('/submit/data', 'submitApplication')->name('submit.add.data');
            Route::get('/custom/chatbot/v2', 'customChatbotV2')->name('chatbot.view');
            Route::post('/generate/response','getDataAndGenerateResponse')->name('chatgpt');
